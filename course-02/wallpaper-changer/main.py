...
class App:
    ...
    def _build_ui(self):
        ...
        status_lbl.pack(side="right", padx=10, pady=5)
        timer_lbl = tk.Label(status_frame, textvariable=self.timer_var)
        timer_lbl.pack(side="left", padx=10, pady=5)
    ...
    def next_now(self):
        ...
        if self.manager.is_slideshow_enabled():
